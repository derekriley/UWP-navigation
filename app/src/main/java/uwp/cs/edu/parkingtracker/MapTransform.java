...
//        this.layoutGrid();
    ...
    /**
     * layoutMarkers() : Creates markers and add the markers to the map passed fragment.
     *
     */
     ...
     *  interuption to the main UI Thread.
     *
     */
    private void attachMarkersToMap(){
        for(MarkerOptions markerOptions : mOptions)
        {
    ...
    /**
     * layoutGrid() : Lays out lines on the grid representing parking lot zones.
     * @param
     * @return
     *
     */
    ...
    {
        createOuterGrid(CONSTANTS.STUDENT_CENTER_PARKING_LOT);
        createHorizontalZoneSeparators(CONSTANTS.STUDENT_CENTER_PARKING_LOT);
        createVerticalZoneSeparators(CONSTANTS.STUDENT_CENTER_PARKING_LOT);
    }

    /**
     * createOuterGrid : Draws the outer parking lot grid of the given parking lot.
     * @param parkingLot
     */
    private void createOuterGrid(int parkingLot)
    {
    ...
    /**
     * createHorizontalZoneSeparators : Draws the horizontal lines that separate the parking lot zones
     *  of the given parking lot.
     *
     * @param parkingLot
     */
    private void createHorizontalZoneSeparators(int parkingLot)
    {
        switch (parkingLot) {
            case CONSTANTS.STUDENT_CENTER_PARKING_LOT:
                mMap.addPolyline(new PolylineOptions()
                        .add(CONSTANTS.FIRST_LOWER_ZONE_DIVIDER_EAST_POINT)
                        .add(CONSTANTS.FIRST_LOWER_ZONE_DIVIDER_WEST_POINT)
                        .width(CONSTANTS.DEFAULT_LINE_WIDTH));
                mMap.addPolyline(new PolylineOptions()
                        .add(CONSTANTS.SECOND_LOWER_ZONE_DIVIDER_EAST_POINT)
                        .add(CONSTANTS.SECOND_LOWER_ZONE_DIVIDER_WEST_POINT)
                        .width(CONSTANTS.DEFAULT_LINE_WIDTH));
                break;
        }
    }
    ...
    /**
     * createVerticalZoneSeparators : Draws the vertical lines that separate the parking lot zone
     *  of the given parking lot.
     *
     * @param parkingLot
     */
    private void createVerticalZoneSeparators(int parkingLot)
    {
        switch (parkingLot)
        {
            case CONSTANTS.STUDENT_CENTER_PARKING_LOT :
                mMap.addPolyline(new PolylineOptions()
                        .add(CONSTANTS.FIRST_VERTICAL_ZONE_DIVIDER_NORTH_POINT)
                        .add(CONSTANTS.FIRST_VERTICAL_ZONE_DIVIDER_SOUTH_POINT)
                        .width(CONSTANTS.DEFAULT_LINE_WIDTH));
                break;
        }
    }
