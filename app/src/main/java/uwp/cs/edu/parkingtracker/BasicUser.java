 ...
 * */
 public class BasicUser extends FragmentActivity {
    ...
    protected uwp.cs.edu.parkingtracker.MapTransform mapTransform;
...
// findViewById(R.id.basic_user_other_lots_button).setOnClickListener(deviceListeners);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Service
        final Intent mServiceIntent = new Intent(this, uwp.cs.edu.parkingtracker.ZoneService.class);
        ...
        // Setup map.
        mapTransform = new uwp.cs.edu.parkingtracker.MapTransform(BasicUser.this);
...
//        }
    ...
    * */
    public void goToExpert(View view) {
        Intent intent = new Intent(this, uwp.cs.edu.parkingtracker.ExpertActivity.class);
        startActivity(intent);
    }

    public void showParkDialogFragment(String zID) {
        uwp.cs.edu.parkingtracker.ParkDialogFragment parkDialogFragment = new uwp.cs.edu.parkingtracker.ParkDialogFragment();
